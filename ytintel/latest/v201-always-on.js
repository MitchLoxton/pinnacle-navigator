...
function loadLatest(){
  ...
  css('v250','v250-intelligence.css?v=0290');css('v260','v260-cloud.css?v=0290');css('v270','v270-forensics.css?v=0290');css('v280','v280-production.css?v=0290');css('v281','v281-ideas.css?v=0290');css('v284','v284-luxe.css?v=0290');css('v290','v290-commercial.css?v=0290');
  ...
  load('v104-media.js?v=0290','v104-media');load('v104-media-proxy.js?v=0290','v104-media-proxy');load('v250-radar-persistence.js?v=0290','v250-radar');load('v250-app.js?v=0290','v250-app');load('v260-cloud.js?v=0290','v260-cloud');load('v260-release.js?v=0290','v260-release');load('v270-forensics.js?v=0290','v270-forensics');load('v270-route.js?v=0290','v270-route');load('v280-production.js?v=0290','v280-production');load('v280-focus.js?v=0290','v280-focus');load('v281-ideas.js?v=0290','v281-ideas');load('v281-auth-fix.js?v=0290','v281-auth-fix');load('v282-product-fix.js?v=0290','v282-product-fix');load('v283-deep-packaging.js?v=0290','v283-deep-packaging');load('v284-luxe.js?v=0290','v284-luxe');load('v290-commercial.js?v=0290','v290-commercial');
}
function setStatus(){const s=$('#status');if(!s)return;s.textContent=`v${window.YTINTEL_VERSION||'0.29.0'} · Intelligence live`;s.style.borderColor='rgba(85,226,157,.48)';s.style.color='#9af1c2';s.title=state.enhancement_configured?'YTIntel always-on analysis is active. GPT-5.6 Sol is available as a cloud enhancement when the provider is available.':'YTIntel always-on analysis is active. Cloud model access is optional; the analyser does not stop when it is unavailable.'}
