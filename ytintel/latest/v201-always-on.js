...
function loadLatest(){
  if(!document.querySelector('link[data-v250]')){const l=document.createElement('link');l.rel='stylesheet';l.href='v250-intelligence.css?v=0281';l.dataset.v250='1';document.head.appendChild(l)}
  if(!document.querySelector('link[data-v260]')){const l=document.createElement('link');l.rel='stylesheet';l.href='v260-cloud.css?v=0281';l.dataset.v260='1';document.head.appendChild(l)}
  if(!document.querySelector('link[data-v270]')){const l=document.createElement('link');l.rel='stylesheet';l.href='v270-forensics.css?v=0281';l.dataset.v270='1';document.head.appendChild(l)}
  if(!document.querySelector('link[data-v280]')){const l=document.createElement('link');l.rel='stylesheet';l.href='v280-production.css?v=0281';l.dataset.v280='1';document.head.appendChild(l)}
  if(!document.querySelector('link[data-v281]')){const l=document.createElement('link');l.rel='stylesheet';l.href='v281-ideas.css?v=0281';l.dataset.v281='1';document.head.appendChild(l)}
  ...
  load('v250-radar-persistence.js?v=0281','v250-radar');
  load('v250-app.js?v=0281','v250-app');
  load('v260-cloud.js?v=0281','v260-cloud');
  load('v260-release.js?v=0281','v260-release');
  load('v270-forensics.js?v=0281','v270-forensics');
  load('v270-route.js?v=0281','v270-route');
  load('v280-production.js?v=0281','v280-production');
  load('v280-focus.js?v=0281','v280-focus');
  load('v281-ideas.js?v=0281','v281-ideas');
  load('v281-auth-fix.js?v=0281','v281-auth-fix');
}
function setStatus(){const s=$('#status');if(!s)return;s.textContent=`v${window.YTINTEL_VERSION||'0.28.1'} · Always-On intelligence live`;s.style.borderColor='rgba(85,226,157,.48)';s.style.color='#9af1c2';s.title=state.enhancement_configured?'YTIntel always-on analysis is active. GPT-5.6 Sol is available as a cloud enhancement when the provider is available.':'YTIntel always-on analysis is active. Cloud model access is optional; the analyser does not stop when it is unavailable.'}
