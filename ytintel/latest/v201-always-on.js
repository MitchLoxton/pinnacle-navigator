...
async function loadLatest(){
  ...
  css('v250','v250-intelligence.css?v=0332');css('v260','v260-cloud.css?v=0332');css('v270','v270-forensics.css?v=0332');css('v280','v280-production.css?v=0332');css('v281','v281-ideas.css?v=0332');css('v284','v284-luxe.css?v=0332');css('v290','v290-commercial.css?v=0332');css('v292','v292-owner-polish.css?v=0332');css('v300','v300-core-analysis.css?v=0332');
  await one('v291-auth-core.js?v=0332','v291-auth-core');
  try{await window.YTIntelAuthReady}catch{}
  const queue=[
    ['v104-media.js?v=0332','v104-media'],['v104-media-proxy.js?v=0332','v104-media-proxy'],
    ['v250-radar-persistence.js?v=0332','v250-radar'],['v250-app.js?v=0332','v250-app'],
    ['v260-cloud.js?v=0332','v260-cloud'],
    ['v270-forensics.js?v=0332','v270-forensics'],['v270-route.js?v=0332','v270-route'],
    ['v280-production.js?v=0332','v280-production'],['v280-focus.js?v=0332','v280-focus'],
    ['v281-ideas.js?v=0332','v281-ideas'],['v281-auth-fix.js?v=0332','v281-auth-fix'],
    ['v282-product-fix.js?v=0332','v282-product-fix'],['v283-deep-packaging.js?v=0332','v283-deep-packaging'],
    ['v284-luxe.js?v=0332','v284-luxe'],['v290-commercial.js?v=0332','v290-commercial'],
    ['v292-owner-polish.js?v=0332','v292-owner-polish'],
    ['v293-release-card.js?v=0332','v293-release-card'],['v294-focus-cleanup.js?v=0332','v294-focus-cleanup'],
    ['v295-core-hardening.js?v=0332','v295-core-hardening'],['v300-network-guard.js?v=0332','v300-network-guard'],
    ['v330-brief.js?v=0332','v330-brief'],['v310-deep-research.js?v=0332','v310-deep-research'],['v300-core-analysis.js?v=0332','v300-core-analysis'],['v300-vault-ui.js?v=0332','v300-vault-ui'],
    
    ['v300-focus.js?v=0332','v300-focus'],['v330-workspace.js?v=0332','v330-workspace']
  ];
...
function setStatus(){const s=$('#status');if(!s||s.dataset.researchState)return;s.textContent='v0.33.2 - Ready';s.title='Model-backed analysis is checked per run. Ready does not imply API credit is available.'}
