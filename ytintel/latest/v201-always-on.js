...
async function loadLatest(){
  ...
  css('v250','v250-intelligence.css?v=0320');css('v260','v260-cloud.css?v=0320');css('v270','v270-forensics.css?v=0320');css('v280','v280-production.css?v=0320');css('v281','v281-ideas.css?v=0320');css('v284','v284-luxe.css?v=0320');css('v290','v290-commercial.css?v=0320');css('v292','v292-owner-polish.css?v=0320');css('v300','v300-core-analysis.css?v=0320');
  await one('v291-auth-core.js?v=0320','v291-auth-core');
  try{await window.YTIntelAuthReady}catch{}
  const queue=[
    ['v104-media.js?v=0320','v104-media'],['v104-media-proxy.js?v=0320','v104-media-proxy'],
    ['v250-radar-persistence.js?v=0320','v250-radar'],['v250-app.js?v=0320','v250-app'],
    ['v260-cloud.js?v=0320','v260-cloud'],
    ['v270-forensics.js?v=0320','v270-forensics'],['v270-route.js?v=0320','v270-route'],
    ['v280-production.js?v=0320','v280-production'],['v280-focus.js?v=0320','v280-focus'],
    ['v281-ideas.js?v=0320','v281-ideas'],['v281-auth-fix.js?v=0320','v281-auth-fix'],
    ['v282-product-fix.js?v=0320','v282-product-fix'],['v283-deep-packaging.js?v=0320','v283-deep-packaging'],
    ['v284-luxe.js?v=0320','v284-luxe'],['v290-commercial.js?v=0320','v290-commercial'],
    ['v292-owner-polish.js?v=0320','v292-owner-polish'],
    ['v293-release-card.js?v=0320','v293-release-card'],['v294-focus-cleanup.js?v=0320','v294-focus-cleanup'],
    ['v295-core-hardening.js?v=0320','v295-core-hardening'],['v300-network-guard.js?v=0320','v300-network-guard'],
    ['v310-deep-research.js?v=0320','v310-deep-research'],['v300-core-analysis.js?v=0320','v300-core-analysis'],['v300-vault-ui.js?v=0320','v300-vault-ui'],
    ['v300-visual-pass.js?v=0320','v300-visual-pass'],
    ['v300-focus.js?v=0320','v300-focus']
  ];
...
function setStatus(){const s=$('#status');if(!s||s.dataset.researchState)return;s.textContent='v0.32.0 - Ready';s.title='Model-backed analysis is checked per run. Ready does not imply API credit is available.'}
