...
async function loadLatest(){
  ...
  css('v250','v250-intelligence.css?v=0294');css('v260','v260-cloud.css?v=0294');css('v270','v270-forensics.css?v=0294');css('v280','v280-production.css?v=0294');css('v281','v281-ideas.css?v=0294');css('v284','v284-luxe.css?v=0294');css('v290','v290-commercial.css?v=0294');css('v292','v292-owner-polish.css?v=0294');
  await one('v291-auth-core.js?v=0294','v291-auth-core');
  try{await window.YTIntelAuthReady}catch{}
  const queue=[
    ['v104-media.js?v=0294','v104-media'],['v104-media-proxy.js?v=0294','v104-media-proxy'],
    ['v250-radar-persistence.js?v=0294','v250-radar'],['v250-app.js?v=0294','v250-app'],
    ['v260-cloud.js?v=0294','v260-cloud'],['v260-release.js?v=0294','v260-release'],
    ['v270-forensics.js?v=0294','v270-forensics'],['v270-route.js?v=0294','v270-route'],
    ['v280-production.js?v=0294','v280-production'],['v280-focus.js?v=0294','v280-focus'],
    ['v281-ideas.js?v=0294','v281-ideas'],['v281-auth-fix.js?v=0294','v281-auth-fix'],
    ['v282-product-fix.js?v=0294','v282-product-fix'],['v283-deep-packaging.js?v=0294','v283-deep-packaging'],
    ['v284-luxe.js?v=0294','v284-luxe'],['v290-commercial.js?v=0294','v290-commercial'],
    ['v292-owner-polish.js?v=0294','v292-owner-polish'],['v293-notes-focus.js?v=0294','v293-notes-focus'],
    ['v293-release-card.js?v=0294','v293-release-card'],['v294-focus-cleanup.js?v=0294','v294-focus-cleanup']
  ];
  for(const [src,key] of queue)await one(src,key);
  try{window.dispatchEvent(new CustomEvent('ytintel:late-layers-ready'))}catch{}
}
function setStatus(){const s=$('#status');if(!s)return;s.textContent='v0.29.4 · Intelligence live';s.style.borderColor='rgba(85,226,157,.48)';s.style.color='#9af1c2';s.title=state.enhancement_configured?'YTIntel always-on analysis is active. GPT-5.6 Sol is available as a cloud enhancement when the provider is available.':'YTIntel always-on analysis is active. Cloud model access is optional; the analyser does not stop when it is unavailable.'}
