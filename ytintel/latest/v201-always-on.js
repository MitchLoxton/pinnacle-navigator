...
function loadLatest(){
  if(!document.querySelector('link[data-v250]')){const l=document.createElement('link');l.rel='stylesheet';l.href='v250-intelligence.css?v=0260';l.dataset.v250='1';document.head.appendChild(l)}
  if(!document.querySelector('link[data-v260]')){const l=document.createElement('link');l.rel='stylesheet';l.href='v260-cloud.css?v=0260';l.dataset.v260='1';document.head.appendChild(l)}
  ...
  load('v250-radar-persistence.js?v=0260','v250-radar');
  load('v250-app.js?v=0260','v250-app');
  load('v260-cloud.js?v=0260','v260-cloud');
}
function setStatus(){
  const s=$('#status');if(!s)return;
  s.textContent=`v${window.YTINTEL_VERSION||'0.26.0'} · Always-On intelligence live`;
