...
function loadLatest(){
  ...
  if(!document.querySelector('link[data-v281]')){const l=document.createElement('link');l.rel='stylesheet';l.href='v281-ideas.css?v=0280';l.dataset.v281='1';document.head.appendChild(l)}
  ...
  load('v280-focus.js?v=0280','v280-focus');
  load('v281-ideas.js?v=0280','v281-ideas');
}
