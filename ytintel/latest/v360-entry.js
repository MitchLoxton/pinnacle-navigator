...
await import('./v366-local-ai-shield.js?v=0374');
await import('./v361-capability-guard.js?v=0374');
await import('./v361-review-fixes.js?v=0374');
await import('./v360-endgame.js?v=0374');
await import('./v366-local-ai-optin.js?v=0374');
await import('./v362-source-polish.js?v=0374');
await import('./v363-premium-brief.js?v=0374');
await import('./v364-fact-surfaces.js?v=0374');
await import('./v369-packaging-depth.js?v=0374');
await import('./v365-canonical-shell.js?v=0374');
await import('./v367-premium-lock.js?v=0374');
await import('./v370-transcript-receipt.js?v=0374');
await import('./v371-feedback-overhaul.js?v=0374');
await import('./v372-endgame-closer.js?v=0374');
await import('./v373-analyse-focus.js?v=0374');
await import('./v374-creator-assets.js?v=0374');
const RELEASE='0.37.4';
...
if('serviceWorker'in navigator){try{navigator.serviceWorker.register('./sw.js?v=0374',{scope:'./'}).catch(()=>null)}catch{}}
