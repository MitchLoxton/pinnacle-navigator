...
await import('./v378-navigation-resilience.js?v=0378');
const RELEASE='0.37.8';
...
if('serviceWorker'in navigator){try{navigator.serviceWorker.register('./sw.js?v=0378',{scope:'./'}).catch(()=>null)}catch{}}
