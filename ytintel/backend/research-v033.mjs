...
export async function handleResearch(req){
 ...
 try{
  ...
  if(action==='health')return json({ok:true,version:'0.33.0',configured:!!await key(),model:MODEL,reasoning_effort:'max',fallback:false,quality_contract:'Monday Brief + synthesis/receipt/coverage gates',stages:STAGES});
