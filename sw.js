const BUILD='5370';
const VERSION='v53.63';
const SHELL='pn-shell-stable-v5370';
const LOCAL=['./','./index.html','./manifest.webmanifest','./icon.svg','./v51.css','./v51.js','./fabrication.js','./stability-core.js','./runtime-late.js','./workshop-ui-fast.js','./morning-pack.js','./miter-48-template.html','./repair.html'];
