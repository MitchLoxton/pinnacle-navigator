...
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon.svg','./v51.css','./v51.js','./foreman.js','./progress.js','./fabrication.js','./miter-template.html','./miter-template-colin-33.html'];
...
self.addEventListener('fetch',event=>{
  ...
  if(url.pathname.endsWith('/v51.js')||url.pathname.endsWith('/v51.css')||url.pathname.endsWith('/foreman.js')||url.pathname.endsWith('/progress.js')||url.pathname.endsWith('/fabrication.js')||url.pathname.endsWith('/miter-template.html')||url.pathname.endsWith('/miter-template-colin-33.html')){
