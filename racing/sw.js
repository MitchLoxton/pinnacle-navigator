const CACHE = 'mitchell-racing-v15-live-tab-fix';
const SHELL = ['./', './index.html', './styles.css?v=12', './app.js?v=13', './live-tab.js?v=2', './manifest.webmanifest', './icon.svg', './apple-touch-icon.png'];
