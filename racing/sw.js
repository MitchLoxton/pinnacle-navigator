const CACHE = 'mitchell-racing-v17-auto-v11-results';
const SHELL = ['./', './index.html', './styles.css?v=12', './app.js?v=14', './live-tab.js?v=4', './manifest.webmanifest', './icon.svg', './apple-touch-icon.png'];
