const BUILD = '1.6.3';
const CACHE = 'mitchell-racing-v20-closing-odds';
const STATIC_SHELL = [
  './styles.css?v=12',
...
self.addEventListener('fetch', event => {
  ...
  const criticalPath = /\/racing\/(?:index\.html|app\.js|live-tab\.js|execution-guard\.js|closing-odds\.js|version\.json|current\.json|stats\.json)$/.test(url.pathname);
