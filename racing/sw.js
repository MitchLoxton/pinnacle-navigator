const BUILD = '1.6.1';
const CACHE = 'mitchell-racing-v18-client-sync';
const STATIC_SHELL = [
  './styles.css?v=12',
...
self.addEventListener('fetch', event => {
  ...
  const criticalPath = /\/racing\/(?:index\.html|app\.js|live-tab\.js|version\.json|current\.json|stats\.json)$/.test(url.pathname);
