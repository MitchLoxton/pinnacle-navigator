const CACHE = 'mitchell-racing-v16-live-odds';
const SHELL = ['./', './index.html', './styles.css?v=12', './app.js?v=13', './live-tab.js?v=3', './manifest.webmanifest', './icon.svg', './apple-touch-icon.png'];
