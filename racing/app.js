(() => {
  ...
  function setChecking() {
    ...
    $('freshness').textContent = 'LIVE V11 · AUTO 15S';
    $('bottomLabel').textContent = 'LIVE V11 · AUTO 15S';
    $('bottomText').textContent = 'Checking whether each race is BET, NO BET or COMPLETE.';
  }
