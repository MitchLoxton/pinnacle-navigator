(function(){
'use strict';
if(window.__PN_RUNTIME_LATE_5366__)return;
window.__PN_RUNTIME_LATE_5366__=true;
var started=false;
...
async function start(){
  ...
  started=true;
  await load('./fabrication.js?v='+BUILD,'__PN_FABRICATION_STABLE_5352__');
  ...
  await load('./stability-core.js?v='+BUILD,'__PN_STABILITY_CORE_5366__');
}
setTimeout(start,0);
setTimeout(start,900);
window.addEventListener('pageshow',function(){setTimeout(start,40);});
document.addEventListener('visibilitychange',function(){if(!document.hidden)setTimeout(start,40);});
})();
