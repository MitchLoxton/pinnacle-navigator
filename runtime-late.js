(function(){
'use strict';
if(window.__PN_RUNTIME_LATE_5380__)return;
window.__PN_RUNTIME_LATE_5380__=true;
...
async function startCore(){
  ...
  await Promise.all([
    load('./email-audit.js?v='+BUILD,'__PN_EMAIL_AUDIT_5377__'),
    load('./task-guides.js?v='+BUILD,'__PN_TASK_GUIDES_5380__')
  ]);
  idle(startExtras);
}
